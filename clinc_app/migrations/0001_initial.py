# Generated by Django 5.2.5 on 2025-09-09 07:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Doctor_Department', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='clinc_app.department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Patient_blood_group', models.CharField(choices=[('A+', 'A+'), ('B+', 'B+'), ('O+', 'O+'), ('AB+', 'AB+'), ('A-', 'A-'), ('B-', 'B-'), ('O-', 'O-'), ('AB-', 'AB-')], max_length=5)),
